...
```shell
nmap -sV -sC -p- -T4 -oN $HOME/Desktop/labs/playgroung/nmap_stapler 192.168.224.148  192.168.198.148
```

After running _nmap_ we see we have the following ports open to our system.

```markdown
# Nmap 7.94 scan initiated Wed Jan 10 09:19:48 2024 as: nmap -sV -sC -p- -T4 -oN /home/greenet/Desktop/labs/playground/staplerr/nmap_stapler 192.168.151.148
Nmap scan report for 192.168.151.148
...
|   Some Capabilities: SupportsLoadDataLocal, Support41Auth, Speaks41ProtocolOld, ConnectWithDatabase, ODBCClient, LongPassword, DontAllowDatabaseTableColumn, IgnoreSpaceBeforeParenthesis, InteractiveClient, Speaks41ProtocolNew, FoundRows, SupportsTransactions, IgnoreSigpipes, SupportsCompression, LongColumnFlag, SupportsMultipleResults, SupportsAuthPlugins, SupportsMultipleStatments
|   Status: Autocommit
|   Salt: *\x7FNM7Xt\x1BF \x19\x0D  %(g'Q}
|_  Auth Plugin Name: mysql_native_password
12380/tcp open   http        Apache httpd 2.4.18 ((Ubuntu))
|_http-server-header: Apache/2.4.18 (Ubuntu)
|_http-title: Tim, we need to-do better next year for Initech
1 service unrecognized despite returning data. If you know the service/version, please submit the following fingerprint at https://nmap.org/cgi-bin/submit.cgi?new-service :
SF-Port666-TCP:V=7.94%I=7%D=1/10%Time=659E3910%P=x86_64-pc-linux-gnu%r(NUL
SF:L,128A,"PK\x03\x04\x14\0\x02\0\x08\0d\x80\xc3Hp\xdf\x15\x81\xaa,\0\0\x1
...
|   Domain name: \x00
|   FQDN: red
|_  System time: 2024-01-10T06:28:47+00:00
| smb2-security-mode: 
|   3:1:1: 
|_    Message signing enabled but not required
|_nbstat: NetBIOS name: RED, NetBIOS user: <unknown>, NetBIOS MAC: <unknown> (unknown)
| smb2-time: 
|   date: 2024-01-10T06:28:47
|_  start_date: N/A

Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Wed Jan 10 09:29:22 2024 -- 1 IP address (1 host up) scanned in 573.74 seconds
```

**FTP enumeration**

connect to anonymous user on the FTP
...
Download a file called **note**

```shell
get note
```

The file will be downloaded t your working location

#### Samba enumeration

```shell
nmap -p 139 --script smb-enum-shares,smb-ls 192.168.198.148
```

!\[\[smb1.png]] !\[\[smb2.png]]

We see port 12380 has a site the is running on it

```bash
http://192.168.198.148:12380
```

**Directory busting**

Finding directories with ffuf

```bash
ffuf -u http://192.168.198.148:12380/FUZZ -w /usr/share/wordlists/dirb/big.txt -t 100
```
